...
2. **Interactive Input Prompts**: Parameter yang memerlukan input manual (seperti Zone, Customer A User, Customer B User, Customer A Project, Customer B Project) akan diminta secara otomatis saat script pertama kali dijalankan jika belum didefinisikan.
...
1. Menjual/membuat Authorized Views A (Texas) dan B (California) di `demo_dataset`.
